    ...
    def print_profit_coll_report(self):
        ...
        for payment in payments:
            ...
            if payment.has_invoices:
                ...
                if payment.communication and ( 'INV' in payment.communication or 'SO' in payment.communication ):
                    temp = self.count_hpp( payment )
                    if len(temp):
                        payment_data.append(temp)
                else:
        ...
        for giro in giros:
            ...
            for line_invoice in giro.giro_invoice_ids:
                ...
                percent = 100
                if line_invoice.invoice_id.amount_total:
                    percent = (line_invoice.amount*100) / line_invoice.invoice_id.amount_total
    ...
    def count_hpp(self, payment):
        ...
        for invoice in invoices:
            ...
            if memo_type:
                ...
                # 0783
                if((count_payment+payment_with_giro) > 0):
